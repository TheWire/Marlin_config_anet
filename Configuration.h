...
//** my name
#define STRING_CONFIG_H_AUTHOR "Andrew Barber" // Who made the changes.
...
//** changed from 3.0 to match anet config
...
//** changed from 275 to 285 for v6 hot end
#define HEATER_0_MAXTEMP 285
#define HEATER_1_MAXTEMP 275
#define HEATER_2_MAXTEMP 275
#define HEATER_3_MAXTEMP 275
#define HEATER_4_MAXTEMP 275
//** changed from 150 to match anet config
...
//** changed from 10 to match anet config
  ...
  // Ultimaker
  //** changed from 22.2 to match anet config
  #define DEFAULT_Kp 21.0
  //** changed from 1.08 to match anet config
  #define DEFAULT_Ki 1.25
  //** changed from 114 to match anet config
...
//** changed from 170 to match anet config
//** 160 guards against false tripping when the extruder fan kicks on.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
 //** changed from { 3000, 3000, 100, 10000 } to match anet config
 ...
 */
//** changed from 3000 to match anet config
...
//** commented in to match anet config on printer with bed leveling enabled
//** used to be #define PROBE_DOUBLE_TOUCH
...
//** changed from true to match anet config
 ...
 */
 //** commented in to enable filament runout
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //** changed from 10 to 4. 10 to many to handle without rotary switch
...
//** commented in and values changed match anet config
...
// Homing speeds (mm/m)
//** chnaged from 50*60 to match anet config
...
//
//** commented out to match anet config
...
// Preheat Constants
//** changed to personal preference
...
//** changed to personal preference + anet abilities
 ...
 */
 //** needed when #define ADVANCED_PAUSE_FEATURE is defined for runout sensor
 ...
 *
 */
//** commented in for bigtreetech lcd
#define SDSUPPORT
...
//
//** commented in to match anet config
//** commented out for bigtreetech
